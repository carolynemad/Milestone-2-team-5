      ...
      >
        ...
        <List>
          {["Schedule", "Notifications"].map((text, index) => (
            <ListItem button key={text}>
              ...
              <ListItemIcon>
                <Link to="/hr/viewschedule">
                  {index === 0 && <ScheduleOutlinedIcon />}
                </Link>
                <Link to="hr/viewnotifications">
                  {index === 1 && <NotificationsActiveOutlinedIcon />}
                </Link>
              </ListItemIcon>
          ...
          {[
            ...
            <ListItem button key={text}>
              <ListItemIcon>
                ...
                <Link to="/hr/updateprofile">
                  {index === 1 && <UpdateOutlinedIcon />}
                </Link>
                <Link to="/hr/resetpassword">
            ...
            (text, index) => (
              <ListItem button key={text}>
                <ListItemIcon>
                  ...
                  <Link to="/hr/removemember">
                    {index === 1 && <RemoveIcon />}
                  </Link>
                  <Link to="/hr/updatemember">
                    {index === 2 && <SystemUpdateAltIcon />}
                  </Link>
                  <Link to="/hr/viewmember">
            ...
            (text, index) => (
              <ListItem button key={text}>
                <ListItemIcon>
                  ...
                  <Link to="/hr/removefaculty">
                    {index === 1 && <RemoveIcon />}
                  </Link>
                  <Link to="/hr/updatefaculty">
                    {" "}
                    {index === 2 && <SystemUpdateAltIcon />}
                  </Link>
                </ListItemIcon>
        ...
        <List>
          {["Add Department", "Remove Department", "Update Department"].map(
            (text, index) => (
              <ListItem button key={text}>
                <ListItemIcon>
                  <Link to="/hr/adddepartment">
                    {index === 0 && <AddIcon />}
                  </Link>
                  <Link to="/hr/removedepartment">
                    {" "}
                    {index === 1 && <RemoveIcon />}
                  </Link>
                  <Link to="/hr/updatedepartment">
                    {index === 2 && <SystemUpdateAltIcon />}
                  </Link>
                </ListItemIcon>
                <ListItemText primary={text} />
            ...
            (text, index) => (
              <ListItem button key={text}>
                <ListItemIcon>
                  ...
                  <Link to="/hr/removelocation">
                    {index === 1 && <RemoveIcon />}
                  </Link>
                  <Link to="/hr/updatelocation">
                    {index === 2 && <SystemUpdateAltIcon />}
                  </Link>
                </ListItemIcon>
                <ListItemText primary={text} />
            ...
            (text, index) => (
              <ListItem button key={text}>
                <ListItemIcon>
                  ...
                  <Link to="/hr/removecourse">
                    {index === 1 && <RemoveIcon />}
                  </Link>
                  <Link to="/hr/updatecourse">
                    {index === 2 && <SystemUpdateAltIcon />}
                  </Link>
                </ListItemIcon>
                <ListItemText primary={text} />
        ...
        <List>
          {["Missing SignIn / SignOut"].map((text, index) => (
            <ListItem button key={text}>
              <ListItemIcon>
                <Link to="/hr/missingsigninsignout">
